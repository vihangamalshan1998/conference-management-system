...
class ResearcherHeader extends Component {
    render() {
        return (
            <div className="bg-dark">
                <div className="row dash-1st ">
                    <div className="col-sm-6 text-light mt-2 mb-2">
                        <a className="text-light" href="/researcherDash"><i className="fas fa-home m-2"></i></a>
                        <a className="text-light" href="/addresearchdoc"><i className="fas fa-folder-plus"></i></a>
